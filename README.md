...
**Evaluate:** Can be used to evaluate the saved models on the training set. Deep learning models and Random Forest in a few minutes but the SVM model can take 45 minutes to evaluate. 
